...
// options passed: -mlittle-endian -mgeneral-regs-only -mabi=lp64 -mbranch-protection=pac-ret+leaf -O2 -std=gnu90 -fno-strict-aliasing -fno-common -fshort-wchar -fno-PIE -fno-asynchronous-unwind-tables -fno-unwind-tables -fno-delete-null-pointer-checks -fno-allow-store-data-races -fstack-protector-strong -fno-omit-frame-pointer -fno-optimize-sibling-calls -ftrivial-auto-var-init=zero -fno-strict-overflow -fstack-check=no -fconserve-stack -fno-builtin-wcslen -fsanitize=kernel-address -fasan-shadow-offset=0xdfffffd000000000 -fsanitize=bounds -fsanitize=shift -fsanitize=integer-divide-by-zero -fsanitize=unreachable -fsanitize=signed-integer-overflow -fsanitize=bool -fsanitize=enum -fsanitize-trap --param=asan-globals=1 --param=asan-instrumentation-with-call-threshold=0 --param=asan-stack=1 --param=asan-instrument-allocas=1 -fstack-protector-strong -fstack-clash-protection
	.text
...
.ascii "->TSK_STACK_CANARY 1360 offsetof(struct task_struct, stack_canary)"	//
// 0 "" 2
...
.ascii "->THREAD_KEYS_USER 3608 offsetof(struct task_struct, thread.keys_user)"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:49:   DEFINE(THREAD_KEYS_KERNEL,	offsetof(struct task_struct, thread.keys_kernel));
// 49 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->THREAD_KEYS_KERNEL 3688 offsetof(struct task_struct, thread.keys_kernel)"	//
// 0 "" 2
