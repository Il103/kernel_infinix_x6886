...
#define THREAD_KEYS_USER 3608 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 3688 /* offsetof(struct task_struct, thread.keys_kernel) */
